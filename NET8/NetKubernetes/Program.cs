...
//con esto se configura la seguridad por tokens por cada request que el cliente envie
...
//declaracion del cors para que acepte los metodos http
builder.Services.AddCors( o => o.AddPolicy("corsapp", builder =>
{
    builder.WithOrigins("*").AllowAnyMethod().AllowAnyHeader();
}));

//AQUI EMPIEZA LA INSTANCIA DEL APP
...
//para inyectarlo dentro de la instancia del app
app.UseCors("corsapp");
...
using (var ambiente = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        //esta linea es la que permite disparar el evento para poder crear las tablas en mi sql server
        await context.Database.MigrateAsync();
        //esta linea inserta la data de prueba
